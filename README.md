...
## About
My website is written entirely in HTML, CSS and JavaScript. I chose to not use a framework such as React or Angular because they are not necassary for this kind of website. While JavaScript is used to add some flare to the website (namely the cow animation), the website will function without JavaScript enabled. It is important the web is accessable on browsers such as W3M or even on older browsers such as IE7.
